...
import { 
  PokeBallContractAddress,
  PokeNFTContractAddress,
  PokeMarketContractAddress,
  LockedStakingContractAddress,
  PokeBallABI,
  PokeNFTABI,
  PokeMarketABI,
  LockedStakingABI
} from 'config/constants/pokeContracts'
 ...
 */
 export const usePokeBallContract = () => {
  return useContract(PokeBallContractAddress, PokeBallABI)
}

export const usePokeNFTContract = () => {
  return useContract(PokeNFTContractAddress, PokeNFTABI)
}

export const usePokeMarketContract = () => {
  return useContract(PokeMarketContractAddress, PokeMarketABI)
}

export const useLockedStakingContract = () => {
  return useContract(LockedStakingContractAddress, LockedStakingABI)
}
